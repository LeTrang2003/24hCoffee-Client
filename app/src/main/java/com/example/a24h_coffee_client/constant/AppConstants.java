package com.example.a24h_coffee_client.constant;

public class AppConstants {
    public static final String SUCCESS = "success";
    public static final String ON_FAILURE_LOGIN = "Đăng nhập thất bại";
    public static final String ON_FAILURE_CHANGE = "Đổi mật khẩu thất bại";
    ...
    public static final String PREFS_NAME = "remember_user";
